...
$sql = "INSERT INTO admin (usuario, password, nombres, email, activo, fecha_alta) VALUES ('admin','$password','Administrador','al196870@alumnos.uacj.mx','1',NOW())";
$con->query($sql);*/
...
<html lang="en">
    <head>
        ...
        <title>Login - Axoclothes admin</title>
